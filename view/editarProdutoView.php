...
<?php require_once('header.php'); 
  ...
  if ($operacao == "Cadastrar"){
    ...
    $eimagem = isset($_FILES['imagem'])?$_FILES['imagem']:"";
    $eprincipal = isset($_POST['eprincipal'])?$_POST['eprincipal']:"";

    $explode = explode(".", $eimagem['name']);
...
<div class="row justify-content-center no-gutters block-9" style="padding-top: 10%">
          <div class="col-md-5 order-md-last d-flex" style="margin-left: 15%">
            ...
            ?>
              ...
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Preço" name="epreco" id="epreco" value=" <?=$preco?>">
                <input type="hidden" class="form-control" placeholder="Nome" name="ecod" id="ecod" value=" <?=$cod?>">
              </div>
              <div class="form-group">
                <input type="file" class="form-control" placeholder="Imagem" name="imagem" id="eimagem" >
              </div>
              <div class="form-group">
                <textarea name="edescricao" id="edescricao" value="<?=$descricao?>" cols="30" rows="7" class="form-control" placeholder="Descricao"></textarea>
              </div>
              <div class="form-group">
